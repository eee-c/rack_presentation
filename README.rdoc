...
The "slides" are best viewed with <code>less -r</code>.  That kinda ruins the punchline, but as those who attened will attest, it wasn't that funny to begin with ;)
